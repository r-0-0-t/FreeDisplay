...
struct BrightnessSliderView: View {
    ...
    var body: some View {
        VStack(spacing: 2) {
            ...
            HStack(spacing: 4) {
                ...
                if display.isBuiltin {
                    ...
                    Circle()
                        ...
                        .frame(width: 5, height: 5)
                        .accessibilityHidden(true)
                    Text(LocalizedStringKey(status ? "DDC" : "Software"))
                        .font(.caption2)
            ...
            .padding(.top, 2)
            .accessibilityLabel(display.isBuiltin ? "Brightness mode: System" : "Brightness mode: \(ddcStatus == true ? "DDC Hardware" : "Software")")
            .help(display.isBuiltin ? "System brightness: controls built-in display brightness via system API" : "DDC: hardware direct brightness control\nSoftware: software-based brightness adjustment")
